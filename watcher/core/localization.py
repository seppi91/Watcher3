...
def get():
    ...
    for lang in os.listdir(locale_dir):
        ...
        core.LANGUAGES[lang] = gettext.translation(
            "watcher", localedir=locale_dir, languages=[lang]
        )

    core.LANGUAGES["en"] = gettext.translation(
        "watcher", localedir=locale_dir, languages=[""], fallback=True
    )
